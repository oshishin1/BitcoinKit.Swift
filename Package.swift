...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/oshishin1/BitcoinCore.Swift.git", .upToNextMajor(from: "2.1.1")),
        .package(url: "https://github.com/oshishin1/Hodler.Swift.git", .upToNextMajor(from: "2.0.0")),
